        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="kelas_jurusan" id="kelas_jurusan" required autocomplete="off" class="input">
                </li>
                <li>
                ...
                <li>
                    <input type="hidden" name="tanggal" value="<?php date("Y-m-d"); ?>" disabled id="tanggal" required autocomplete="off" class="input">
                </li>
                <li>
