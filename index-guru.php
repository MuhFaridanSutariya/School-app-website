...
<body>
        <div class="container">
            <div class="sidebar">
                ...
                <a href="jawaban.php" class="next"><img src="img/next.png"></a>
                <a href="tambah.php"><div class="tambah">Tambah Tugas</div></a>
            ...
            <div class="content">
                ...
                <table border="1" cellpadding="10" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="td">
                            <a href="hapus.php?id=<?php echo $sw["id"]; ?>" onclick="return confirm('Yakin mau dihapus?');" ><div class="hapus">Hapus</div></a>
                            <a href="ubah.php?id=<?php echo $sw["id"]; ?>" ><div class="ubah">Ubah</div></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
